...
::: {.g-col-12 .g-col-md-4 .section-card .text-reset}
[![](talks/brown-antifragility-2025.jpg){.talk-thumb}]()

#### [Error Diagnosis & Low-Skill Models](talks/brown-antifragility-2025.qmd){.talk-title}
::: {.talk-meta}
{{< fa university >}} Brown University · Sept 2025
:::
:::
...
Full list in my [CV →]((files/Ryan_OLoughlin_CV.pdf))
</div>
...
**Error Diagnosis & Low-Skill Models** NCAR CGD, Oct 2022     [Read More →](talks/ncar-cgd-error-taxonomy-2022.qmd)
