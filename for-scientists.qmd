...
description: "Talks, workshops, and collaborations where Ryan O’Loughlin helps climate scientists communicate uncertainty and build trustworthy models."
canonical: https://Ryan-J-OLoughlin.github.io/for-scientists.html
---
...
[![Flyer for Ryan O’Loughlin’s CUNY ASRC talk on convergence, divergence, and trust in climate models](talks/cuny-esi-convergence-trust-2025.jpg){.talk-thumb}](talks/cuny-esi-convergence-trust-2025.qmd)
...
::: {.g-col-12 .g-col-md-4 .section-card .text-reset}
[![Flyer for the NASA GISS seminar on why disagreement between climate models is valuable](talks/nasa-giss-disagreement-2023.jpg){.talk-thumb}](talks/nasa-giss-disagreement-2023.qmd)
...
::: {.g-col-12 .g-col-md-4 .section-card .text-reset}
[![Flyer for the NCAR Climate & Global Dynamics seminar on diagnosing error in climate models](talks/ncar-cgd-error-taxonomy-2022.png){.talk-thumb}](talks/ncar-cgd-error-taxonomy-2022.qmd)
